...
case "$DISTRO" in
  "ubuntu"|"debian")
    ...
    sudo apt update
    sudo apt install -y git git-lfs zip zoxide zsh vim micro curl build-essential
    ;;
  "arch"|"cachyos")
    echo "📦 Installing packages for Arch/CachyOS..."
    sudo pacman -Syu --noconfirm git git-lfs zip zoxide zsh vim micro curl base-devel
    ...
    yay -S --noconfirm git git-lfs zip zoxide zsh vim micro curl
    ;;
  "fedora")
    echo "📦 Installing packages for Fedora..."
    sudo dnf install -y git git-lfs zip zoxide zsh vim micro curl development-tools
    ;;
  "macos")
    ...
    brew install git git-lfs zoxide vim micro
    ;;
esac
